      ...
      getCustomerColumns(
        {
          ...
          onDeleteAction: (customer) => handleDeleteConfirmation([customer]),
        },
        agencies
      ),
    [agencies]
      ...
      <ResourceDataTable
        ...
        renderGridItemAction={(customer) => (
          <CustomerCard
            customer={customer}
            agencies={agencies}
            onEditAction={(c) => handleEditAction(c.customer_id!)}
            onDeleteAction={(customer) => {
