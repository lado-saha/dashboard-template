...
import { ProductListItemData, ProductType } from "@/types/product";
...
export default function ManageProductsPage() {
  ...
  const fetchAllProducts = useCallback(async () => {
    ...
    try {
      ...
      const mockData: ProductListItemData[] = [
        ...
        {
          id: "srv1",
          name: "Consultation Session (1hr)",
          productType: "SERVICE",
          currentState: "PLANNED",
          basePrice: 150,
          createdAt: new Date(now - 3 * dayMs).toISOString(),
          updatedAt: new Date(now - 1 * dayMs).toISOString(),
          description: "One hour expert consultation on marketing strategy.",
          isScheduled: true,
        ...
        },
        {
          ...
          description: "Full-size wireless keyboard and ergonomic mouse.",
        },
        {
          id: "srv2",
          name: "Website Design Package - Basic",
          productType: "SERVICE",
          currentState: "PUBLISHED",
          basePrice: 1200,
          createdAt: new Date(now - 30 * dayMs).toISOString(),
          updatedAt: new Date(now - 5 * dayMs).toISOString(),
          description: "Basic 5-page website design and deployment.",
        },
        {
          id: "srv3",
          ...
          description: "Ongoing website updates and security checks.",
        },
        {
          id: "res3",
          ...
          updatedAt: new Date(now - 1 * dayMs).toISOString(),
          description: "Gel wrist support mouse pad.",
        },
        {
          id: "srv4",
          ...
          description: "Comprehensive SEO audit with actionable report.",
        },
        {
          id: "res4",
          name: "Standing Desk Converter XL",
          productType: "RESOURCE",
          currentState: "FREE",
          basePrice: 199.0,
          createdAt: new Date(now - 15 * dayMs).toISOString(),
          updatedAt: new Date(now - 4 * dayMs).toISOString(),
          description: "Large standing desk converter for dual monitors.",
        },
        {
          id: "srv5",
          name: "Cloud Migration Strategy Workshop",
          productType: "SERVICE",
          currentState: "CANCELLED",
          basePrice: 2500.0,
          createdAt: new Date(now - 45 * dayMs).toISOString(),
          updatedAt: new Date(now - 20 * dayMs).toISOString(),
          description: "2-day workshop for cloud migration planning.",
        },
        {
          id: "res5",
          ...
          updatedAt: new Date(now - 1 * dayMs).toISOString(),
          description: "Supports 4K resolution and high refresh rates.",
        },
        {
          id: "srv6",
          ...
          updatedAt: new Date(now - 6 * dayMs).toISOString(),
  ...
  const renderMainContent = () => {
    ...
    if (pageMode === "create")
      return (
        <ProductForm mode="create" onFormSubmitSuccess={handleFormSuccess} />
      );
